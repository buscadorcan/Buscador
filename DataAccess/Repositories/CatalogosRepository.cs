...
namespace DataAccess.Repositories
{
    ...
    public class CatalogosRepository : BaseRepository, ICatalogosRepository
    {
        ...
        List<VwGrilla> ICatalogosRepository.ObtenerVwGrilla()
        {
            throw new NotImplementedException();
        }

        List<VwFiltro> ICatalogosRepository.ObtenerVwFiltro()
        {
            throw new NotImplementedException();
        }

        List<VwDimension> ICatalogosRepository.ObtenerVwDimension()
        {
            throw new NotImplementedException();
        }

        List<Homologacion> ICatalogosRepository.ObtenerGrupos()
        {
            throw new NotImplementedException();
        }

        VwHomologacionGrupo? ICatalogosRepository.FindVwHGByCode(string codigoHomologacion)
        {
            throw new NotImplementedException();
        }

        List<vwFiltroDetalle> ICatalogosRepository.ObtenerFiltroDetalles(string codigo)
        {
            throw new NotImplementedException();
        }

        List<VwRol> ICatalogosRepository.ObtenerVwRol()
        {
            throw new NotImplementedException();
        }

        VwRol ICatalogosRepository.FindVwRolByHId(int idHomologacionRol)
        {
            throw new NotImplementedException();
        }

        List<VwMenu> ICatalogosRepository.ObtenerVwMenu()
        {
            throw new NotImplementedException();
        }

        List<ONA> ICatalogosRepository.ObtenerOna()
        {
            throw new NotImplementedException();
        }

        List<vwONA> ICatalogosRepository.ObtenervwOna()
        {
            throw new NotImplementedException();
        }

        List<VwHomologacionGrupo> ICatalogosRepository.ObtenerVwHomologacionGrupo()
        {
            throw new NotImplementedException();
        }

        List<vwPanelONA> ICatalogosRepository.ObtenerVwPanelOna()
        {
            throw new NotImplementedException();
        }

        List<vwEsquemaOrganiza> ICatalogosRepository.ObtenervwEsquemaOrganiza()
        {
            throw new NotImplementedException();
        }
    }
