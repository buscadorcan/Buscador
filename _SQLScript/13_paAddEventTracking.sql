...
BEGIN
	...
	INSERT INTO [EventTracking] (TipoUsuario, NombreUsuario, NombrePagina, NombreControl, NombreAccion, ParametroJson, ErrorTracking)
    VALUES (@TipoUsuario, @NombreUsuario, @NombrePagina, @NombreControl, @NombreAccion, @ParametroJson, @ErrorTracking);
END;
GO
