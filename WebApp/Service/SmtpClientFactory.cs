...
namespace WebApp.Service
{
  public class SmtpClientFactory(IConfiguration configuration) : ISmtpClientFactory
  {
    ...
    /// <summary>
    /// Crea una instancia de SmtpClient con la configuración de correo electrónico proporcionada en los settings.
    /// </summary>
    /// <returns>Una instancia de SmtpClient configurada.</returns>
